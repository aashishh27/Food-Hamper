%pip install streamlit langchain-community openai chromadb plotly shap seaborn joblib scikit-learn
...
with tab6:
    ...
    st.markdown("Upload your CSV and ask questions about it. The AI will retrieve context
